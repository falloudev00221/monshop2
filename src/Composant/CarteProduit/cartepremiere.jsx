...
export const CartPremiere =(even)=>{
    ...
    useEffect(() => {
        ...
        const fetchProducts = async () => {
          try {
            ...
            const q = query(collection(db, "TopProduitPresentation"));
    ...
    return(
        ...
        <img id='cardx2img' src={product.photo1} class="card-img-top" alt="..."/>
        <div class="card-body">
           
            <h6  id='nameProduct' className='text-danger'>{product.nom}</h6>

             </div>
             <button className='btn btn-info'>commande via whatsapp</button>
        </div  >
