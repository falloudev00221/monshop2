...
export const CartCadeau =(even)=>{
    ...
    useEffect(() => {
        ...
        const fetchProducts = async () => {
          try {
            ...
            const q = query(collection(db, "sac"));
    ...
    return(
        ...
        <div class="card mt-2">
        <img id='gfd' src={product.photo1} class="card-img-top" alt="..."/>
        <div class="card-body">
            <h6 id='nameProduct' className='text-black'>{product.nom}</h6>
        </div>
        <button className='btn btn-success'>pv whatsapp</button>
        </div>
